...
const TOTAL_NUMBE = 0;
do {
  console.log("Number output:", currentNumbe);
  currentNumbe--;
} while (currentNumbe > TOTAL_NUMBE);
...
while (startNumber <= LAST_NUMBER) {
  if (startNumber % 5 === 0) {
    console.log("Output numbers:", startNumber);
  }
  startNumber++;
}

let firstNumber = 10;
const LAST_ONE_NUMBER = 50;

do {
  if (firstNumber % 5 === 0);
  console.log("Number output", firstNumber);
  firstNumber++;
